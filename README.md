...
### 3. Add Your API Key
Open `backend/agent_mcp.py` and replace the placeholder API key with your actual Groq key:
```python
...
- `frontend/index.html`: The premium chat interface.
- `backend/main.py`: The FastAPI application.
- `backend/agent_mcp.py`: The core LLM and MCP routing logic.
